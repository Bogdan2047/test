...
if(LS.getItem('comments') !== null){
    ...
    //     ones.comments = commen


    //     end.push(ones);


    //     post.innerHTML = end.map((item) => {
    //             coment.innerHTML = '';

    //               let per = item.comments;
    //               let get;
    ...
    //             </div>
    //             <div class='action'>
    //                 <button class='comments' id="${item.id}">add comments</button>
    //                 <button class='hide' id="${item.id}">hide comments</button>
    //             </div>
    //         </div>
    //         <div class='this' id='${get.id}'>
    //             <p>${get.text}</p>
    //         </div>
    //            `     
